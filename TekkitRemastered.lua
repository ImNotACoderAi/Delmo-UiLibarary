...
CDropdown:Add(1, "Custom Option")
CDropdown:Add(2, "Custom Option")
CDropdown:Add(3, "Custom Option")
CDropdown:Add(4, "Custom Option")
local CButton2 = Custom:Button({
	Title = "Check Selected",
	Callback = function() 
		print("Selected Items:", CDropdown:GetSelectedItems())
		Notify:Notify({
			Title = "Custom Notification",
			Desc = "Selected items are: " .. CDropdown:GetSelectedItems()
		})
	end
...
local CSlider = Tab:Slider()
local CDropdown = Tab:Dropdown()
Notify:Notify()
Notify:Warning()
CDropdown:Add(1, "Item")
CDropdown:Add(2, "Item")
CDropdown:Add(3, "Item")
CDropdown:Add(4, "Item")